...
export const DEFAULT_AI_SECURITY_MODELS = [
  ...
  {
    "id": "llama-4-cybersec",
    "name": "Meta Llama 4 CyberSec (70B / 405B)",
    "provider": "Meta AI",
    "type": "Open-Weights",
    ...
    "metrics": {
      "patchingRate": 68.8,
      "exploitDetection": 91.0,
      "threatHunting": 92.5,
      "injectionDefense": 93.0,
      "insecureCodeRate": 3.1
    },
    "primaryStrengths": [
      "Trained specifically on verified US-CERT threat advisories and MITRE ATT&CK enterprise datasets",
      "Native dual-use cyber safety filter blocking weaponized payload generation while permitting defensive analysis",
      "Exceptional sovereign deployment utility for classified and private air-gapped security enclaves"
    ],
    "weaknesses": [
      "Requires fine-tuned system prompting to disable over-refusals on benign penetration testing queries"
    ],
    "testedBy": [
      "Meta CyberSecEval 3",
      "SWE-bench Verified",
    ...
    "recommendedUse": "Sovereign Air-Gapped SOC, Defensive Threat Analysis, Threat Intelligence Summarization",
    "lastTested": "2026-09-14"
  },
  {
    "id": "mistral-codestral-2",
    "name": "Mistral Codestral 2 / Large 3",
    "provider": "Mistral AI",
    "type": "Open-Weights",
    "license": "Mistral Non-Commercial / Commercial",
    "contextWindow": "256K Tokens",
    "overallScore": 90.6,
    "rank": 12,
    "metrics": {
      "patchingRate": 67.8,
      "exploitDetection": 89.0,
      "threatHunting": 91.2,
      "injectionDefense": 91.8,
      "insecureCodeRate": 3.2
    },
    "primaryStrengths": [
      "Industry-leading fill-in-the-middle (FIM) code completion and inline vulnerability mitigation",
      "Massive 256K context window with exceptional low-latency inference speeds across European sovereign infrastructure",
      "Multi-lingual threat intel parsing natively supporting French, German, Spanish, and English"
    ],
    "weaknesses": [
      "Slightly lower complex zero-day exploit deobfuscation rates compared to top-3 frontier models"
    ],
    "testedBy": [
      "SWE-bench Verified",
      "OWASP GenAI",
    ...
    "recommendedUse": "European Sovereign Enterprise Clouds, DevSecOps Inline IDE Patching, Fast Vulnerability Auditing",
    "lastTested": "2026-09-14"
  }
];
