...
export const DEFAULT_AI_SECURITY_MODELS = [
  {
    ...
    "metrics": {
      ...
      "threatHunting": 97.2,
      "injectionDefense": 95.4,
      "insecureCodeRate": 2.4
    },
    "primaryStrengths": [
      "Top-tier SWE-bench Verified score (70.3% base, 74.0% with agent scaffolding) for autonomous multi-file CVE remediation",
      "Superior de-obfuscation of polymorphic shellcode, C/C++ memory corruption primitives, and rootkit binaries",
      "Industry-leading resistance to indirect prompt injection in production RAG pipelines and tool sandboxes"
    ],
    "weaknesses": [
  ...
  {
    "id": "openai-o3",
    "name": "OpenAI o3 (Full Cyber Reasoning)",
    "provider": "OpenAI",
    "type": "Frontier LLM",
    "license": "Proprietary API",
    "contextWindow": "200K Tokens",
    ...
    "metrics": {
      ...
      "threatHunting": 96.8,
      "injectionDefense": 94.2,
      "insecureCodeRate": 2.5
    },
    "primaryStrengths": [
      "Highest raw SWE-bench Verified performance (71.7%) and Cybench CTF binary exploit verification",
      "Recursive test-time reasoning self-corrects complex multi-step cyber exploit chains",
      "Rigorous structured JSON schema enforcement for automated SOAR orchestration playbooks"
    ],
    "weaknesses": [
      "High compute requirement for top-tier reasoning budget settings"
    ],
    "testedBy": [
      "Cybench",
      "SWE-bench Verified",
    ...
    "recommendedUse": "Vulnerability Research, Red Teaming, CTF Automation, Complex Code Patching",
    "lastTested": "2026-09-11"
  },
  {
    "id": "gemini-2-0-pro",
    ...
    "metrics": {
      ...
      "threatHunting": 97.8,
      "injectionDefense": 94.5,
      "insecureCodeRate": 3
    },
    "primaryStrengths": [
      "Industry's largest 2M token context window ingests full enterprise firewall logs and full network pcap dumps",
      "Native multimodal correlation of network topology architectures and binary disassembly graphs",
      "Continuous grounding with Google Cloud Security Telemetry, Mandiant threat research, and VirusTotal"
    ],
    "weaknesses": [
    ...
    "recommendedUse": "Enterprise Log Aggregation, Forensic Timeline Reconstruction, Cloud IAM Audits, Mandiant Integration",
    "lastTested": "2026-09-11"
  },
  {
    "id": "openai-o3-mini",
    ...
    "metrics": {
      ...
      "threatHunting": 94.6,
      "injectionDefense": 93.1,
      "insecureCodeRate": 2.9
    },
    "primaryStrengths": [
      "Sub-second initial token generation with high-efficiency test-time reasoning",
      "Exceptional cost-to-performance ratio for high-throughput enterprise API scanning",
      "High accuracy in automated code security linting and static analysis (SAST)"
    ],
    "weaknesses": [
      "Lower multi-file codebase awareness compared to full o3 model"
    ],
    "testedBy": [
      "Cybench",
      "SWE-bench Verified",
    ...
    "recommendedUse": "High-Throughput SAST, Triage Automation, Fast Red-Team Verification",
    "lastTested": "2026-09-11"
  },
  {
    "id": "grok-3-cyber",
    ...
    "primaryStrengths": [
      "Deep test-time reasoning trained on 100k H100 cluster with advanced algorithmic problem solving",
      "Real-time web and technical documentation synthesis for fast-breaking zero-day disclosures",
      "Strong resistance against social engineering and prompt manipulation in adversarial evaluations"
    ],
    "weaknesses": [
      "Limited native enterprise SIEM connectors compared to established cloud hyperscalers"
    ],
    "testedBy": [
      "Stanford CAIS",
      "USENIX Security",
    ...
    "recommendedUse": "Threat Intelligence Aggregation, Real-Time OSINT Analysis, Zero-Day Discovery",
    "lastTested": "2026-09-11"
  },
  {
    ...
    "metrics": {
      ...
      "threatHunting": 92.8,
      "injectionDefense": 88.6,
      "insecureCodeRate": 4.2
    },
    "primaryStrengths": [
  ...
  },
  {
    ...
    "metrics": {
      "patchingRate": 65.2,
      "exploitDetection": 86.4,
      "threatHunting": 91.2,
      "injectionDefense": 89.6,
      "insecureCodeRate": 3.2
    },
    "primaryStrengths": [
      "The industry's leading open-weights coding model across 90+ programming languages",
      "Exceptionally low insecure code generation rate (3.2%), rivaling top commercial frontier models",
  ...
  },
  {
    ...
    "metrics": {
      "patchingRate": 62,
      "exploitDetection": 83.5,
      "threatHunting": 98.2,
      "injectionDefense": 91.4,
      "insecureCodeRate": 4.2
    },
    "primaryStrengths": [
      "Unmatched native integration into Microsoft Defender XDR, Sentinel, and Entra ID",
      "Highest SIEM threat hunting accuracy (98.2%) with automated KQL query synthesis",
  ...
  },
  {
    ...
    "metrics": {
      "patchingRate": 63.5,
      "exploitDetection": 85.2,
      "threatHunting": 92,
      "injectionDefense": 90.5,
      "insecureCodeRate": 4.4
    },
    "primaryStrengths": [
