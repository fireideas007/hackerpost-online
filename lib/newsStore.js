...
import { resolveUniqueEditorialImage } from './editorialImageCatalog.js';
...
const SEED_PUBLISHED_ARTICLES = [
  ...
  },
  {
    ...
    disclosureStatus: "Disclosed",
    disclosureDate: "2026-09-14",
    imageUrl: "https://images.unsplash.com/photo-1573164713988-8665fc963095?w=800&auto=format&fit=crop&q=80"
  },
  {
    id: "pub-20260914-5",
    ...
    disclosureDate: "2026-09-14",
    imageUrl: "https://images.unsplash.com/photo-1618060932014-4deda4932554?w=800&auto=format&fit=crop&q=80"
  },
  {
    id: "pub-20260914-6",
  ...
  },
  {
    ...
    disclosureStatus: "Funded (Series D)",
    disclosureDate: "2026-08-20",
    imageUrl: "https://images.unsplash.com/photo-1655720828018-edd2daec9349?w=800&auto=format&fit=crop&q=80"
  },
  {
    id: "pub-bench-1",
    ...
    imageUrl: "https://images.unsplash.com/photo-1676299081847-824916de030a?w=800&auto=format&fit=crop&q=80"
  }
];
...
function getDB() {
  ...
  try {
    ...
    // Senior Newsroom Visual Audit: Guarantee 0 duplicate images across all published stories
    ...
    parsed.publishedArticles.forEach(art => {
      ...
      if (!art.imageUrl || usedImages.has(art.imageUrl)) {
        art.imageUrl = resolveUniqueEditorialImage(art, usedImages);
        updatedImages = true;
      } else {
        usedImages.add(art.imageUrl);
      }
    });
...
export function addPublishedArticle(article) {
  ...
  const usedUrls = new Set(db.publishedArticles.map(a => a.imageUrl));
  const imageUrl = article.imageUrl || resolveUniqueEditorialImage({ ...article, title, slug }, usedUrls);
